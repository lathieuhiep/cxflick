	...
	<div class="warp pt-6 pb-6">
		<div class="container">
			<header class="page-header">
				<h1 class="page-title">
					<?php
					printf( esc_html__( 'Kết quả tìm kiếm cho: %s', 'essential-features-addon' ), '<span>' . get_search_query() . '</span>' );
					?>
				</h1>
			</header>
			...
			?>
				<p><?php esc_html_e( 'Không có kết quả nào được tìm thấy', 'essential-features-addon' ); ?></p>
			<?php endif; ?>
		</div>
	</div>
<?php
